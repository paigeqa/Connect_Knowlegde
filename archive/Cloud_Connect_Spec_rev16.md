...
last_updated: 2026-06-12 (rev 16)
---
...
| F-STG-run-reset | CONFIRMED (rev16, Design Brief 2026-06-12) | Navbar의 **▶ Run 버튼**은 Connect mode와 Preview mode 모두에서 **모든 인스턴스를 초기화**한다. | Run 클릭 후 Stage에 열린 모든 Pie 인스턴스가 초기 상태로 돌아가는지 확인. Connect mode / Preview mode 양쪽에서 동일하게 초기화 동작하는지 회귀. Edit↔Preview 모드 전환 시 인스턴스 유지(§1 Instance 정의)와 구별 — 전환은 유지, Run은 초기화. Player·Plugin 연결 상태에 미치는 영향 정의 필요(WIP). |
...
| 2026-06-12 (rev16) | **Design Brief 2026-06-12 07:43 2차 갱신 반영**. F-STG-run-reset(신설 CONFIRMED) — Navbar ▶ Run 버튼이 Connect mode / Preview mode 모두에서 모든 인스턴스를 초기화하는 동작 명문화. | F-STG-run-reset(신설) | Connect on Cloud (Design Brief, Tay Jung) — Notion 2026-06-12 07:43 2차 갱신 |
