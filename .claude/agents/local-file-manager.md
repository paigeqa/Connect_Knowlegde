...
description: Cloud Connect QA 수집기 2/3. Connect Knowlege 폴더를 재귀적으로 읽고 Cloud_Connect_Spec.md 전문 + 나머지 .md/.txt 요약을 반환한다. 읽기 전용(편집·삭제 금지). Decision Helper가 호출하거나, 로컬 지식 폴더 현황 수집이 필요할 때 사용.
---
...
## Output
{
  ...
  "spec_path": "/Users/paige/Desktop/Boost/Connect Knowlege/Cloud_Connect_Spec.md",
